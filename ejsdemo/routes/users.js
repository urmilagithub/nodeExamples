    ...
    if( !errors ) {   //No errors were found.  Passed Validation!
		...
		********************************************/
		...
		req.getConnection(function(error, conn) {
			...
			//conn.query('INSERT INTO users (name, age, email, address, phone, dob) VALUES (?, ?, ?, ?, ?, ?) ', user.name, user.age, user.email, user.address, user.phone, user.dob, function(err, result) {	
				//if(err) throw err
				if (err) {
					req.flash('error', err)
